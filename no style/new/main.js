...
onValue(ref(db, "saldo/saldo"), (snapshot) => {
    ...
    document.getElementById("saldoparent").style = "animation: shake 0.6s ease-in-out;"

    document.getElementById("saldoparent").addEventListener("animationend", function(){
        document.getElementById("saldoparent").style = "animation: none"
    })
});
